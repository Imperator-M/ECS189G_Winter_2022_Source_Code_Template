...
print('GCN Accuracy:  ' + str(round(score['accuracy'], 5)))
print('GCN Precision: ' + str(round(score['precision'], 5)))
print('GCN Recall:    ' + str(round(score['recall'], 5)))
print('GCN f1:        ' + str(round(score['f1'], 5)))
print('************ Finish ************')
# ------------------------------------------------------
