...
if 1:
    ...
    acc_ax.plot(setting_obj.method.epoch_history, setting_obj.method.accuracy_history)
    loss_ax.plot(setting_obj.method.epoch_history, setting_obj.method.loss_history)
    # Axis Lables
