...
class Method_MLP(method, nn.Module):
    ...
    def __init__(self, mName, mDescription):
        ...
        self.fc_layer_2 = nn.Linear(4, 5)
        self.activation_func_2 = nn.ReLU()
        self.fc_layer_3 = nn.Linear(5, 6)
        self.activation_func_3 = nn.ReLU()
        self.fc_layer_4 = nn.Linear(6, 10)
    ...
    def forward(self, x):
        ...
        k = self.activation_func_3(self.fc_layer_3(g))
        y_pred = self.activation_func_4(self.fc_layer_4(k))
        return y_pred
