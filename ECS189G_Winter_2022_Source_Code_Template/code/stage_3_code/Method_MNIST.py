...
class Method_MNIST(method, nn.Module):
    ...
    def run(self):
        ...
        model = Method_MNIST('convolutional neural network', '') #I was having problems getting the model from the script so I just added it manually here
